...
const index = () => {
  ...
  const recommended = [
    {
      ...
      name: "KFC",
      image:
        "https://theperfectplace.co.za/wp-content/uploads/KFC-Buckets-menu-1.webp?ezimgfmt=rs:364x364/rscb2/ngcb2/notWebP",
      time: "35 - 45",
      type: "Chicken",
    },
    {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "$f8f8f8" }}>
      ...
      >
        <EvilIcons name="location" size={30} color="#00CCBB" />
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 15, fontWeight: "500" }}>Deliver To</Text>
          <Text style={{ color: "gray", fontSize: 16, marginTop: 2 }}>
      ...
      >
        <TextInput placeholder="Search for finding the Food"></TextInput>
        <AntDesign name="search1" size={24} color="#00CCBB" />
      </View>
      <Carousel />
      <Categories />
        ...
        {recommended?.map((item, index) => (
          ...
          >
            ...
            <View style={{ padding: 10, flexDirection: "column" }}>
              ...
              <Text style={{ flex: 1, marginTop: 3, color: "gray" }}>
                {item?.type}
              </Text>
              <View
      ...
      <Text style={{ textAlign: "center", color: "gray", letterSpacing: 5 }}>
        ALL RESTAURANTS
      </Text>
